...
WINDOW_PATTERN = "L"    # sliding window pattern: L=full, S=half context (T4: full only)

# Optimization
TOTAL_BATCH_SIZE = 2**13 # ~8K tokens per optimizer step (T4: minimum 1 grad accum step)
...
# Model size
DEPTH = 4               # number of transformer layers (T4)
DEVICE_BATCH_SIZE = 4   # per-device batch size (must be <= TOTAL_BATCH_SIZE / seq_len)
